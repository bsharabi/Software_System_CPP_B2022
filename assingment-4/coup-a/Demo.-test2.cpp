...
int main()
{
	...
	*/
	...
	cout << duke.coins() << endl;		 // prints 1
	cout << assassin.coins() << endl;	 // prints 2

	captain.foreign_aid();
	contessa.foreign_aid();

	cout << captain.coins() << endl;  // prints 3
	cout << contessa.coins() << endl; // prints 3

	duke.tax();
	cout << duke.coins() << endl; // prints 4

	assassin.income();
	cout << assassin.coins() << endl; // prints 3

	ambassador.foreign_aid();
	cout << ambassador.coins() << endl; // prints 3

	captain.steal(contessa);
	cout << contessa.coins() << endl; // prints 4
	cout << captain.coins() << endl;  // prints 5

	contessa.foreign_aid();
	cout << contessa.coins() << endl; // prints 3

	duke.tax();
	cout << duke.coins() << endl; // prints 7
